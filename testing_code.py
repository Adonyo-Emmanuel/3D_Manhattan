...
- p_name : Pathway name from which the gene belong or shares with other genes
    # ...
    ...
    - A figure formatted for plotly.graph_objects.
        ...
        if highlight:
            if not isinstance(highlight, bool):
                ...
                if not tmp.empty: # Checks if the temporary DF is not empty ie contains significant snps. 
